...
export default function BlogHero({ content }: { content: ContentType }) {
  ...
  return (
    <section
      className="relative flex h-[100lvh] min-h-[650px] max-h-[800px] items-center justify-center overflow-hidden"
    >
      {content.image ? (
